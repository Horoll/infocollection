<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\wamp64\www\project\infocollection/application/index\view\checksubmited\checkform1.html";i:1492614576;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
	...
	<body>
        ...
        <div id="display">
            <br>
                <h2>提交学院：<span class="school"><?php echo $schoolname; ?></span></h2>
            <hr>
            ...
            <div id="table">
                ...
                <a href="<?php echo url('Exportfile/exportword').'?form=form1&id='.$data['id']; ?>"><button class="btn btn-success"><span class="glyphicon glyphicon-log-out"></span>&nbsp;导出成word</button></a>
            </div>
        </div>
