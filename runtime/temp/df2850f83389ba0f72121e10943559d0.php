<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\wamp64\www\project\infocollection/application/index\view\checksubmited\checkform2.html";i:1492428711;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <div id="table">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td colspan="3"><?php echo $data['project_type']; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo $data['contact_tel']; ?></td>
            </tr>
            <tr>
        ...
        <a href="<?php echo url('Exportfile/exportword').'?form=form2&id='.$data['id']; ?>"><button class="btn btn-success"><span class="glyphicon glyphicon-log-out"></span>&nbsp;导出成word</button></a>
    </div>
