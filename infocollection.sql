...
insert  into `form3`(`id`,`school_id`,`task_id`,`unit`,`secretary_name`,`num1`,`num2`,`num3`,`text1`,`text2`,`text3`,`attachment_dir`,`attachment_name`) values (1,1,33,'信息工程学院 表单三','123',123,123,123,'信息工程学院 表单三','信息工程学院 表单三','信息工程学院 表单三','schools/20170407\\e25bae755ed34053b4b8ffa0151dc177.doc','组织部--优秀分团委申报材料.doc'),(2,2,33,'理学院 表单三','理学院 表单三',123,123,123,'理学院 表单三理学院 表单三理学院 表单三','理学院 表单三','理学院 表单三','schools/20170407\\c61901f6422f4706fd36f2915adf2f4e.doc','组织部--优秀分团委申报材料.doc'),(3,1,33,'123','222',222,333,333,'啊啊啊','啊啊啊','啊啊啊',NULL,NULL);
